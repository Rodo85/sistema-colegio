...
from .views import (
    ...
    reporte_matricula, reporte_religion, reporte_estudiantes,
...
urlpatterns = [
    ...
    path('reporte-estudiantes/', reporte_estudiantes, name='reporte_estudiantes'),
    path('reporte-religion/', reporte_religion, name='reporte_religion'),
