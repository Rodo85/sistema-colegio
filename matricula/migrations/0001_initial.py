# Generated by Django 5.2.3 on 2025-08-01 17:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('config_institucional', '0004_alter_periodolectivo_anio'),
        ('core', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recibe_afectividad_sexualidad', models.BooleanField(default=False, verbose_name='Recibe Afectividad y Sexualidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='config_institucional.periodolectivo')),
                ('seccion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='config_institucional.seccion')),
                ('subgrupo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='config_institucional.subgrupo')),
            ],
            options={
