    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posee_carnet_conapdis', models.BooleanField(blank=True, null=True, verbose_name='Posee carnet de CONAPDIS')),
                ('posee_valvula_drenaje_lcr', models.BooleanField(blank=True, null=True, verbose_name='Posee válvula de drenaje LCR')),
                ('toma_medicamento', models.BooleanField(blank=True, null=True, verbose_name='Toma algún medicamento')),
                ('medicamento_dosis', models.CharField(blank=True, max_length=100, null=True, verbose_name='Dosis de medicamento')),
                ('usa_apoyo', models.BooleanField(blank=True, null=True, verbose_name='Usa algún tipo de apoyo')),
                ...
                ('posee_control', models.BooleanField(blank=True, null=True, verbose_name='Posee algún tipo de control')),
