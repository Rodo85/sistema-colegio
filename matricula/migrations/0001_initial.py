    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ed_religiosa', models.BooleanField(blank=True, null=True, verbose_name='Recibe Ed. Religiosa')),
                ...
                ('autoriza_derecho_imagen', models.BooleanField(blank=True, null=True, verbose_name='Autoriza derecho de imagen')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('estado', 'activo')), fields=('institucion', 'estudiante', 'curso_lectivo'), name='uniq_matricula_activa_por_institucion_estudiante_anio'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('principal', True)), fields=('institucion', 'estudiante'), name='unique_principal_por_estudiante_institucion'),
        ),
        migrations.AlterUniqueTogether(
            name='encargadoestudiante',
            unique_together={('institucion', 'estudiante', 'persona_contacto', 'parentesco')},
        ),
        migrations.AlterUniqueTogether(
            name='plantillaimpresionmatricula',
